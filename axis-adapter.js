...
// Render Studio uses Y-up in the interactive Three.js viewport because that is
// Three.js' natural convention. STL conventionally uses Z-up. Keep the conversion
// in one place so imported and exported models preserve their physical orientation.
...
STLExporter.prototype.parse = function patchedStlExport(inputScene, options) {
  ...
  // Normalize binary exports for file consumers while leaving ASCII alone.
